...
class TermoDeUso extends StatefulWidget {
  TermoDeUso({Key? key}) : super(key: key);
  bool isUserConcerned = false;
  @override
  State<TermoDeUso> createState() => _TermoDeUsoState();
}

class _TermoDeUsoState extends State<TermoDeUso> {
