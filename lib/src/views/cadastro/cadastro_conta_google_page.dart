...
class CadastroContaGooglePage extends StatefulWidget {
  const CadastroContaGooglePage({Key? key}) : super(key: key);

  @override
  _CadastroContaGooglePageState createState() =>
      _CadastroContaGooglePageState();
}

class _CadastroContaGooglePageState extends State<CadastroContaGooglePage> {
